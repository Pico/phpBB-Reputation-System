...
$lang = array_merge($lang, array(
	...
	'RS_WARNING'				=> 'Avertir l`utilisateur',

	'RS_EMPTY_DATA'				=> 'Il n`y a pas de points de réputation.',
	'RS_NA'						=> 'n/a',
	'RS_NO_COMMENT'				=> 'Vous ne pouvez pas laissez le champ de commentaire vide.',
	'RS_NO_ID'					=> 'No ID',
	'RS_NO_POST_ID'				=> 'Ce post n`existe pas.',
	'RS_NO_POWER'				=> 'Votre réputation est trop faible.',
	'RS_NO_POWER_LEFT'			=> 'Pas assez points de pouvoir de réputation.<br/>Attendez qu`ils renouvelle.<br/>Votre pouvoir de réputation est %s',
	'RS_NO_USER_ID'				=> 'L`utilisateur demandé n`éxiste pas.',
	'RS_TOO_LONG_COMMENT'		=> 'Votre commentaire contient %1$d caractères. Le nombre maximal de caractères autorisés est %2$d.',
	'RS_COMMENT_TOO_LONG'		=> 'Commentaire trop long.<br />Le nombre max de caractères est de : %s. Votre commentaire:',

	'RS_NO_POST'				=> 'Ce post néxiste pas.',
	...
	'RS_HIDE_POST'					=> 'Ce message a été fait par <strong>%1$s</strong> et a été caché car il avait une réputation trop faible. %2$s',
	'RS_SHOW_HIDDEN_POST'			=> 'Afficher ce message',
	'RS_SHOW_HIDE_HIDDEN_POST'		=> 'Afficher / Cacher',
	'RS_ANTISPAM_INFO'				=> 'Vous ne pouvez pas donner de réputation si tôt. Essayez plus tard.',
	'RS_POST_REPUTATION'			=> 'Réputation de post',
	'RS_USER_REPUTATION'			=> '%s\'s réputation',
	'RS_YOU_RATED'					=> 'Vous avez noté ce post. Points:',

	'RS_VOTE_POWER_LEFT_OF_MAX'		=> '%1$d points de pouvoir de réputation restant à %2$d.<br />Maximum par vote: %3$d',
