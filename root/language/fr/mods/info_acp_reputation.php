...
$lang = array_merge($lang, array(
	...
	'ACP_REPUTATION_SYSTEM_EXPLAIN'		=> 'Vous pouvez ici accéder à tout les réglages et fonctionnalités du Système de réputation qui sont nécessaires pour le configurer.',
	'ACP_REPUTATION_OVERVIEW'			=> 'Présentation',
	'ACP_REPUTATION_SETTINGS'			=> 'Réglages',
	'ACP_REPUTATION_SETTINGS_EXPLAIN'	=> 'Sur cette page vous pouvez configurer les paramètres du Système de réputations. Ils sont divisés en groupe.',
	...
	'UCP_REPUTATION_LIST'				=> 'Lister',
	'UCP_REPUTATION_GIVEN'				=> 'points donnés',
	'UCP_REPUTATION_SETTING'			=> 'Réglages',
	...
	'RS_PER_PAGE_EXPLAIN'					=> 'Combien de rangées doit-on afficher dans la table des points de réputation?',
	'RS_DISPLAY_AVATAR'						=> 'Afficher les avatars',
	'RS_SORT_MEMBERLIST_BY_REPO'			=> 'Trier les membres par leur réputation',
	'RS_SORT_MEMBERLIST_BY_REPO_EXPLAIN'	=> 'Lorsque la liste de membres est triée par réputation il est plus logique de le vérifier régulièrement pour garder un œil sur le développement. Vous pouvez éteindre cette fonctionnalité pour revenir au comportement de tri par nom dùtilisateur par défaut.',
	'RS_POINT_TYPE'							=> 'Méthode dàffichage des points',
	'RS_POINT_TYPE_EXPLAIN'					=> 'L`affichage des points de réputation peut être affiché comme la valeur exacte des points de réputation qu`un utilisateur a donné ou comme une image montrant un plus ou moins pour les points positifs ou négatifs. La méthode par l`image est utile si vous configurez des points de réputation alors qu`une notation est toujours égale à un seul point.',
	'RS_POINT_VALUE'					=> 'Valeur',
	'RS_POINT_IMG'							=> 'Image',

	'RS_POST_RATING'				=> 'Activer la notation de post',
	'RS_ALLOW_REPUTATION_BUTTON'	=> 'Proposer et activer le système de réputation dans tous les forums',
	'RS_HIGHLIGHT_POST'				=> 'Mise en évidence d`un post',
	'RS_HIGHLIGHT_POST_EXPLAIN'		=> 'Post avec note plus haute que le nombre défini ici est en surbrillance. Définir la valeur sur 0 désactive ce comportement.<br /><em>Note:</em> Vous pouvez modifier la mise en évidence par défaut en éditant <strong>highlight</strong> class in reputation.css.',
