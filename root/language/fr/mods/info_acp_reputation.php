...
$lang = array_merge($lang, array(
	...
	'RS_HIGHLIGHT_POST_EXPLAIN'		=> 'Un post avec une note plus haute que le nombre défini ici sera en surbrillance. Définir la valeur sur 0 désactive ce comportement.<br /><em>Note:</em> Vous pouvez modifier la mise en évidence par défaut en éditant <strong>highlight</strong> class dans reputation.css.',
