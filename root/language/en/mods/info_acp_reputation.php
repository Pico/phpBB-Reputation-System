...
$lang = array_merge($lang, array(
	...
	'RS_SORT_MEMBERLIST_BY_REPO_EXPLAIN' => 'When the memberlist is being sorted by reputation it makes more sense to check it regularly to keep an eye on development. You may switch it off to keep the default behaviour.<br />By default it’s sorted by username.',
	...
	'RS_USER_RATING_GAP_EXPLAIN'	=> 'Time period, in which user cannot rate an user, who was already rated by them. They have to wait for a certain time to be able to rate the user again. Setting the value to 0 disables this behaviour and user can rate same user only once.',
	...
	'RS_POWER_RENEWAL_EXPLAIN'		=> 'This controls how users can spend earned power.<br/>If you set that option, users have to wait for the given time to be able to vote again. The greater reputation power user has, the more points he can spend in set time.<br/>Recommended 5 hours.<br />Setting the value to 0 disables this behaviour and users can vote without waiting.',
	...
	'RS_POWER_EXPLAIN_EXPLAIN'		=> 'Explain users how reputation power is calculated.',
	...
	'RS_RANKS_PATH_EXPLAIN'			=> 'Path under your phpBB root directory, e.g. <samp>images/reputation</samp>.',
