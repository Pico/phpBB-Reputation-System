...
$lang = array_merge($lang, array(
	...
	'RS_SYNC_EXPLAIN'				=> 'You can resynchronise Reputation System after a mass removal of posts/topics/users, splitting/merging of topics, setting/removing Global Announcements, changing post authors, conversions from others systems, etc. This may take a while. You will be notified when the process is completed.',
	'RS_SYNC_STEP_DEL'				=> 'Step 1/6 - remove reputation points of non-existent users',
	'RS_SYNC_STEP_POSTS_DEL'		=> 'Step 2/6 - remove reputation points of deleted posts',
	'RS_SYNC_STEP_POST_AUTHOR'		=> 'Step 3/6 - checking author of a post and synchronising reputation entry if it was changed',
	'RS_SYNC_STEP_FORUM'			=> 'Step 4/6 - checking forum settings and synchronising post reputation influence on user reputation',
	'RS_SYNC_STEP_USER'				=> 'Step 5/6 - synchronisation of users reputations',
	'RS_SYNC_STEP_POSTS'			=> 'Step 6/6 - synchronisation of posts reputations',
