...
$lang = array_merge($lang, array(
	...
	'RS_STATUS'			=> 'Reputation System status',
	'RS_AJAX_STATUS'	=> 'AJAX functions',

	'RS_ENABLE'						=> '<span style="color:red;">Enable Reputation System</span>',
	'RS_AJAX_ENABLE'				=> '<span style="color:green;">Enable AJAX</span>',
	'RS_AJAX_ENABLE_EXPLAIN'		=> 'This option enables AJAX for the Reputation System. If there is a conflict with another script, you can turn it off and use the Reputation System without AJAX.',
	'RS_NEGATIVE_POINT'				=> 'Allow negative points',
	'RS_NEGATIVE_POINT_EXPLAIN'		=> 'When disabled users can not give negative points, which is similar to Facebook’s "Like" feature.',
	'RS_MIN_REP_NEGATIVE'			=> 'Minimum reputation for negative voting',
	'RS_MIN_REP_NEGATIVE_EXPLAIN'	=> 'How much reputation a user must have earned before they can give negative points. Setting the value to 0 disables this behaviour.',
	...
	'RS_PER_POPUP_EXPLAIN'			=> 'How many rows of reputations points should be shown in the popup box (works only if AJAX is enabled)?<br /><em>You are limited from 1 to 10.</em>',
	'RS_SORT_MEMBERLIST_BY_REPO'	=> 'Sort memberlist by reputation',
	...
	'RS_POST_DISPLAY'				=> 'Display post rating by',
	'RS_POST_DISPLAY_EXPLAIN'		=> 'Post ratings can be displayed as the total number of votes (or “likes”) cast or as the total sum of power points awarded to the post by users votes.',
	'RS_POINT_METHOD'				=> 'Total power points',
	'RS_USER_METHOD'				=> 'Total votes cast',
	'RS_POST_DETAIL'				=> 'Display post details during post rating',
	'RS_POST_DETAIL_EXPLAIN'		=> 'Only when AJAX voting is disabled.<br/>This option allows users to see the post message and basic information about user when rating a post.',
	...
	'RS_TOPLIST_DIRECTION_EXPLAIN'	=> 'Display the users in the list in a horizontal or vertical orientation.',
	...
	'RS_SYNC_EXPLAIN'				=> 'You can resynchronise Reputation System after a mass removal of posts/topics/users, splitting/merging of topics, setting/removing Global Announcements, changing post authors, conversions from others systems, etc. This may take a while. You will be notified when the process is complete.',
	...
	'RS_TRUNCATE'				=> 'Clear reputations',
	'RS_TRUNCATE_EXPLAIN'		=> 'This procedure completely removes all reputations.<br /><strong>Action is not reversible!</strong>',
	'RS_TRUNCATE_CONFIRM'		=> 'Are you sure you wish to remove all reputations?',
