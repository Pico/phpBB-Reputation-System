...
$lang = array_merge($lang, array(
	'ACP_REPUTATION_SYSTEM'				=> 'Reputationssystem',
	...
	'LOG_REPUTATION_DELETED'		=> '<strong>Bewertung gelöscht</strong><br />Von Benutzer: %1$s<br />An Benutzer: %2$s<br />Punkte: %3$s<br/>Typ: %4$s<br/>Bewertungs-ID: %5$s',
	'LOG_POST_REPUTATION_CLEARED'	=> '<strong>Beitragsbewertung gelöscht</strong><br />Autor des Beitrags: %1$s<br />Beitragsthema: %2$s',
