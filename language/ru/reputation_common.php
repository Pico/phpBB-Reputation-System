...
$lang = array_merge($lang, array(
	...
	'NOTIFICATION_RATE_POST_POSITIVE'	=> 'Получена <strong>положительная оценка</strong> сообщения от пользователя %s',
	'NOTIFICATION_RATE_POST_NEGATIVE'	=> 'Получена <strong>отрицательная оценка</strong> сообщения от пользователя %s',
	'NOTIFICATION_RATE_USER'			=> '<strong>Оценен</strong> %s',
));
